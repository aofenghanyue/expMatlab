...
% --- Executes on button press in pushbutton_start_op.
function pushbutton_start_op_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_start_op (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
